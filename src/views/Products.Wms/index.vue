  ...
  <div>
    ...
    <VSection :title="$t('header')">
      ...
      <p style="text-align: center">
        ...
        >
          <source src="https://img.als-yuchuan.com/wms/video.mp4" type="video/mp4" >
        </video>
      </p>
    </VSection>
