<template>
  <div id="about">
      ...
      <div class="columns is-vcentered">
        ...
        <div class="column">
          <div class="content">
            ...
            <p class="is-hidden-tablet is-size-3 has-text-centered">
              公司介绍
            </p>
            <p>
              上海玉串总部在上海的奉贤区，由海外归国行业技术精英组建而成，是一家以自动化物流设备集成为依托，
              集物流装备研发、系统规划、设计、加工制造、安装调试、客户培训、
              售后服务于一体的一站式物流输送系统集成的企业。
              本公司致力于帮助客户全面提高生产资材供给、成品垂直/水平输送之自动化水平，
              最终提升客户的生产物流、仓储物流的流程自动化、信息可视化的管理水平。
            </p>
            <p>
              本公司拥有完整、科学的质量管理体系，标准 规范的国际一流的供应链体系，
              我们以诚信经营、匠心智造和比肩德、日的产品质量获得业界的广泛认可。
              管理团队本着“敢于创新，与时俱进，永不满足，挑战不止”的创新精神，不断加强生产管理水平、严把质量关，
              以其产品质量稳定和价格优势，在市场竞争中脱颖而出。
              本公司致力于不断改进产品生产工艺和提升系统综合品质，并且不断的发展新的产品去保持市场的竞争能力。
              以“真诚、务实、优质、高效”为企业宗旨，竭诚为国内外企业提供优质服务。
            </p>
          </div>
        </div>
      </div>
    ...
    <VSection title="企业理念" style="padding: 0 0 0 0">
      <div class="columns is-multiline">
        ...
        >
          <div
            class="box is-flex is-vcentered"
            style="height: 100%; width: 100%; padding: 2rem 2rem"
          >
